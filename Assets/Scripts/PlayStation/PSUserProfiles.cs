...
{
#if UNITY_PS5 || UNITY_PS4
    public static class PSUserProfiles
    {
        ...
        private static void OnReachabilityNotification(UserSystem.ReachabilityEvent reachabilityEvent)
        {
            ...
            Debug.Log(System.String.Format("    UserId : 0x{0:X}", reachabilityEvent.UserId));
            Debug.Log("    State : " + reachabilityEvent.State.ToString());
        }

        private static void OnSignedInNotification(UserSystem.SignedInEvent signedInEvent)
        {
            Debug.Log("SignIn Notification : ");
        ...
        static WebApiFilters globalUserFilters;

#if UNITY_PS5
        static bool signinEventEnabled = false;
        static bool reachabilityEventEnabled = false;
#endif
