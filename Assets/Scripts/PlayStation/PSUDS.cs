...
namespace Com.MorganHouston.Imprecision
{
    ...
    public static class PSUDS
    {
        ...
        public static void PostUDSStartEvent(string activityID)
        {
            UniversalDataSystem.UDSEvent myEvent = new UniversalDataSystem.UDSEvent();

            myEvent.Create("activityStartSolo");

            myEvent.Properties.Set("activityId", activityID);

            PostEvent(myEvent);
        }

        public static void PostUDSEndEvent(string outcome, int wave)
        {
            UniversalDataSystem.UDSEvent myEvent = new UniversalDataSystem.UDSEvent();

            myEvent.Create("activityEnd");

            myEvent.Properties.Set("activityId", "activityBossCube");
            myEvent.Properties.Set("outcome", outcome);
            myEvent.Properties.Set("score", wave);
        ...
        private static void PostEvent(UniversalDataSystem.UDSEvent udsEvent)
        {
            UniversalDataSystem.PostEventRequest request = new UniversalDataSystem.PostEventRequest();
            ...
            stringRequest.UserId = PSGamePad.activeGamePad.loggedInUser.userId;
        ...
        private static void OutputEvent(UniversalDataSystem.UDSEvent udsEvent)
        {
