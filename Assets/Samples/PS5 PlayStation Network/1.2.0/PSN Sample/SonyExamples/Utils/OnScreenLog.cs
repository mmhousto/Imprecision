    ...
    public class OnScreenLog : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            lock (syncObject)
            {
                ...
                float screenLogHeight = (Screen.height * 0.80f) - (style.lineHeight + 4); // Space on the screen to show the log
        ...
        static public void Add(string msg, Color color, bool keepNewLines = false)
        {
            Add(msg, color, keepNewLines, true);
        }
